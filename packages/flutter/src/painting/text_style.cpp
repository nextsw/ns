...
TextStyle TextStyleCls::copyWith(Paint background, Color backgroundColor, Color color, String debugLabel, TextDecoration decoration, Color decorationColor, TextDecorationStyle decorationStyle, double decorationThickness, String fontFamily, List<String> fontFamilyFallback, List<FontFeature> fontFeatures, double fontSize, FontStyle fontStyle, List<FontVariation> fontVariations, FontWeight fontWeight, Paint foreground, double height, bool inherit, TextLeadingDistribution leadingDistribution, double letterSpacing, Locale locale, TextOverflow overflow, String package, List<Shadow> shadows, TextBaseline textBaseline, double wordSpacing) {
    ...
    assert([=] () {
        if (this->debugLabel != nullptr) {
            newDebugLabel = debugLabel or __s("(${this.debugLabel}).copyWith");
        }
        return true;
    }());
    return make<TextStyleCls>(inherit or this->inherit, this->foreground == nullptr && foreground == nullptr? color or this->color : nullptr, this->background == nullptr && background == nullptr? backgroundColor or this->backgroundColor : nullptr, fontSize or this->fontSize, fontWeight or this->fontWeight, fontStyle or this->fontStyle, letterSpacing or this->letterSpacing, wordSpacing or this->wordSpacing, textBaseline or this->textBaseline, height or this->height, leadingDistribution or this->leadingDistribution, locale or this->locale, foreground or this->foreground, background or this->background, shadows or this->shadows, fontFeatures or this->fontFeatures, fontVariations or this->fontVariations, decoration or this->decoration, decorationColor or this->decorationColor, decorationStyle or this->decorationStyle, decorationThickness or this->decorationThickness, newDebugLabel, fontFamily or _fontFamily(), fontFamilyFallback or this->fontFamilyFallback, package or _package, overflow or this->overflow);
}
...
TextStyle TextStyleCls::apply(Color backgroundColor, Color color, TextDecoration decoration, Color decorationColor, TextDecorationStyle decorationStyle, double decorationThicknessDelta, double decorationThicknessFactor, String fontFamily, List<String> fontFamilyFallback, List<FontFeature> fontFeatures, double fontSizeDelta, double fontSizeFactor, FontStyle fontStyle, List<FontVariation> fontVariations, int fontWeightDelta, double heightDelta, double heightFactor, TextLeadingDistribution leadingDistribution, double letterSpacingDelta, double letterSpacingFactor, Locale locale, TextOverflow overflow, String package, List<Shadow> shadows, TextBaseline textBaseline, double wordSpacingDelta, double wordSpacingFactor) {
    ...
    return make<TextStyleCls>(inherit, foreground == nullptr? color or this->color : nullptr, background == nullptr? backgroundColor or this->backgroundColor : nullptr, fontFamily or _fontFamily(), fontFamilyFallback or this->fontFamilyFallback, fontSize == nullptr? nullptr : fontSize! * fontSizeFactor + fontSizeDelta, fontWeight == nullptr? nullptr : FontWeightCls::values[(fontWeight!->index + fontWeightDelta)->clamp(0, FontWeightCls::values->length - 1)], fontStyle or this->fontStyle, letterSpacing == nullptr? nullptr : letterSpacing! * letterSpacingFactor + letterSpacingDelta, wordSpacing == nullptr? nullptr : wordSpacing! * wordSpacingFactor + wordSpacingDelta, textBaseline or this->textBaseline, height == nullptr? nullptr : height! * heightFactor + heightDelta, leadingDistribution or this->leadingDistribution, locale or this->locale, foreground, background, shadows or this->shadows, fontFeatures or this->fontFeatures, fontVariations or this->fontVariations, decoration or this->decoration, decorationColor or this->decorationColor, decorationStyle or this->decorationStyle, decorationThickness == nullptr? nullptr : decorationThickness! * decorationThicknessFactor + decorationThicknessDelta, overflow or this->overflow, package or _package, modifiedDebugLabel);
}
...
TextStyle TextStyleCls::lerp(TextStyle a, TextStyle b, double t) {
    ...
    auto _c1 = make<PaintCls>();_c1.color = a->color!;auto _c2 = make<PaintCls>();_c2.color = b->color!;auto _c3 = make<PaintCls>();_c3.color = a->backgroundColor!;auto _c4 = make<PaintCls>();_c4.color = b->backgroundColor!;return make<TextStyleCls>(b->inherit, a->foreground == nullptr && b->foreground == nullptr? ColorCls->lerp(a->color, b->color, t) : nullptr, a->background == nullptr && b->background == nullptr? ColorCls->lerp(a->backgroundColor, b->backgroundColor, t) : nullptr, ui->lerpDouble(a->fontSize or b->fontSize, b->fontSize or a->fontSize, t), FontWeightCls->lerp(a->fontWeight, b->fontWeight, t),  < 0.5? a->fontStyle : b->fontStyle, ui->lerpDouble(a->letterSpacing or b->letterSpacing, b->letterSpacing or a->letterSpacing, t), ui->lerpDouble(a->wordSpacing or b->wordSpacing, b->wordSpacing or a->wordSpacing, t),  < 0.5? a->textBaseline : b->textBaseline, ui->lerpDouble(a->height or b->height, b->height or a->height, t),  < 0.5? a->leadingDistribution : b->leadingDistribution,  < 0.5? a->locale : b->locale, (a->foreground != nullptr || b->foreground != nullptr)?  < 0.5? a->foreground or (_c1) : b->foreground or (_c2) : nullptr, (a->background != nullptr || b->background != nullptr)?  < 0.5? a->background or (_c3) : b->background or (_c4) : nullptr,  < 0.5? a->shadows : b->shadows,  < 0.5? a->fontFeatures : b->fontFeatures,  < 0.5? a->fontVariations : b->fontVariations,  < 0.5? a->decoration : b->decoration, ColorCls->lerp(a->decorationColor, b->decorationColor, t),  < 0.5? a->decorationStyle : b->decorationStyle, ui->lerpDouble(a->decorationThickness or b->decorationThickness, b->decorationThickness or a->decorationThickness, t), lerpDebugLabel,  < 0.5? a->_fontFamily() : b->_fontFamily(),  < 0.5? a->fontFamilyFallback : b->fontFamilyFallback,  < 0.5? a->_package : b->_package,  < 0.5? a->overflow : b->overflow);
}

TextStyle TextStyleCls::getTextStyle(double textScaleFactor) {
    auto _c1 = make<PaintCls>();_c1.color = backgroundColor!;return ui->make<TextStyleCls>(color, decoration, decorationColor, decorationStyle, decorationThickness, fontWeight, fontStyle, textBaseline, leadingDistribution, fontFamily, fontFamilyFallback, fontSize == nullptr? nullptr : fontSize! * textScaleFactor, letterSpacing, wordSpacing, height, locale, foreground, background or (backgroundColor != nullptr? (_c1) : nullptr), shadows, fontFeatures, fontVariations);
}
...
void TextStyleCls::debugFillProperties(String prefix, DiagnosticPropertiesBuilder properties) {
