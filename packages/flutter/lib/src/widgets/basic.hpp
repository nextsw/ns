...
private:
     ...
     _UbiquitousInheritedElementCls(InheritedWidget widget);
...
public:
    ...
    virtual void  rotate(Unknown alignment, double angle, Unknown child, Unknown filterQuality, Unknown key, Unknown origin, Unknown transformHitTests);

    virtual void  translate(Unknown child, Unknown filterQuality, Unknown key, Offset offset, Unknown transformHitTests);

    virtual void  scale(Unknown alignment, Unknown child, Unknown filterQuality, Unknown key, Unknown origin, double scale, double scaleX, double scaleY, Unknown transformHitTests);
...
public:
     ...
     CenterCls(Unknown child, double heightFactor, Unknown key, double widthFactor);
private:
...
private:
     ...
     _OffstageElementCls(SingleChildRenderObjectWidget widget);
};
...
public:
    int index;
     ...
     IndexedStackCls(AlignmentGeometry alignment, Unknown children, int index, Unknown key, StackFit sizing, TextDirection textDirection);
...
public:
    ...
    virtual void  fill(Unknown bottom, Unknown child, Unknown key, Unknown left, Unknown right, Unknown top);
...
public:
     ...
     RowCls(Unknown children, CrossAxisAlignment crossAxisAlignment, Unknown key, MainAxisAlignment mainAxisAlignment, MainAxisSize mainAxisSize, TextBaseline textBaseline, TextDirection textDirection, VerticalDirection verticalDirection);
...
public:
     ...
     ColumnCls(Unknown children, CrossAxisAlignment crossAxisAlignment, Unknown key, MainAxisAlignment mainAxisAlignment, MainAxisSize mainAxisSize, TextBaseline textBaseline, TextDirection textDirection, VerticalDirection verticalDirection);
...
public:
     ...
     ExpandedCls(Unknown child, int flex, Unknown key);
...
public:
    ...
    virtual void  unwrapped(Unknown children, Unknown clipBehavior, Unknown delegate, Unknown key);
...
public:
    ...
    HitTestBehavior behavior;
     ...
     MetaDataCls(HitTestBehavior behavior, Unknown child, Unknown key, Object metaData);
...
public:
    ...
    virtual void  fromProperties(Unknown child, Unknown container, Unknown excludeSemantics, Unknown explicitChildNodes, Unknown key, Unknown properties);
