...
ViewportCls::ViewportCls(double anchor, AxisDirection axisDirection, double cacheExtent, CacheExtentStyle cacheExtentStyle, Key center, Clip clipBehavior, AxisDirection crossAxisDirection, Key key, ViewportOffset offset, List<Widget> slivers) : MultiChildRenderObjectWidget(slivers) {
    {
...
ShrinkWrappingViewportCls::ShrinkWrappingViewportCls(AxisDirection axisDirection, Clip clipBehavior, AxisDirection crossAxisDirection, Key key, ViewportOffset offset, List<Widget> slivers) : MultiChildRenderObjectWidget(slivers) {
    {
        assert(offset != nullptr);
    }
}
