...
AnimatedModalBarrierCls::AnimatedModalBarrierCls(bool barrierSemanticsDismissible, Animation<Color> color, bool dismissible, Key key, VoidCallback onDismiss, String semanticsLabel) : AnimatedWidget(color) {
}
