...
template<typename T : Notification> class NotificationListenerCls : public ProxyWidgetCls {
public:
...
template<typename T : Notification> using NotificationListener = std::shared_ptr<NotificationListenerCls<T : Notification>>;

template<typename T : Notification> class _NotificationElementCls : public ProxyElementCls {
public:
...
template<typename T : Notification> using _NotificationElement = std::shared_ptr<_NotificationElementCls<T : Notification>>;
