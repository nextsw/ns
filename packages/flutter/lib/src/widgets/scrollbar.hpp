...
template<typename T>
class RawScrollbarStateCls : public StateCls<T> {
public:
...
template<typename T>
using RawScrollbarState = std::shared_ptr<RawScrollbarStateCls<T>>;
