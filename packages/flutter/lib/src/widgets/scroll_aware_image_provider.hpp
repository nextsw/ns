...
template<typename T : Object> class ScrollAwareImageProviderCls : public ImageProviderCls<T> {
public:
...
template<typename T : Object> using ScrollAwareImageProvider = std::shared_ptr<ScrollAwareImageProviderCls<T : Object>>;
