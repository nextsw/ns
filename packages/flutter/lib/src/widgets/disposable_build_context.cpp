...
template<typename T>
DisposableBuildContextCls<T>::DisposableBuildContextCls(T _state) {
    {
...
template<typename T>
BuildContext DisposableBuildContextCls<T>::context() {
...
template<typename T>
void DisposableBuildContextCls<T>::dispose() {
    _state = nullptr;
}

template<typename T>
bool DisposableBuildContextCls<T>::_debugValidate() {
