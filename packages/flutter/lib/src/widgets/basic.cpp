...
void TransformCls::rotate(AlignmentGeometry alignment, double angle, Unknown child, FilterQuality filterQuality, Unknown key, Offset origin, bool transformHitTests)

void TransformCls::translate(Unknown child, FilterQuality filterQuality, Unknown key, Offset offset, bool transformHitTests)

void TransformCls::scale(AlignmentGeometry alignment, Unknown child, FilterQuality filterQuality, Unknown key, Offset origin, double scale, double scaleX, double scaleY, bool transformHitTests)
...
void PositionedCls::fill(double bottom, Unknown child, Unknown key, double left, double right, double top)
...
void FlowCls::unwrapped(Unknown children, Clip clipBehavior, FlowDelegate delegate, Unknown key)
...
void SemanticsCls::fromProperties(Unknown child, bool container, bool excludeSemantics, bool explicitChildNodes, Unknown key, SemanticsProperties properties)
